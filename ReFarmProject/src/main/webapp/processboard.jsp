...
<title>게시 등록 수정 삭제 처리</title>
</head>
<body>
	<!-- 게시의 등록, 수정, 삭제를 위한 자바빈즈 이용 선언-->
	<jsp:useBean id="brd" class="ReFarmProject.BoardEntity" scope="page" />
	<jsp:useBean id="brddb" class="ReFarmProject.BoardDAO" scope="page" />
	<% 
		//한글 처리를 위해 문자인코딩 지정
	...
	%>
					...
					<jsp:setProperty name="brd" property="showcnt" />
